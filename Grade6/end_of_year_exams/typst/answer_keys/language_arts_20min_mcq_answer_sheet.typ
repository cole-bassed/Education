...
#table(columns: (0.7fr, 1fr, 1fr, 1fr, 1fr), align: center, inset: 6pt, stroke: rgb("999999"),
  ...
  [5], [#bubble("A", correct: false)], [#bubble("B", correct: true)], [#bubble("C", correct: false)], [#bubble("D", correct: false)],
  ...
  [9], [#bubble("A", correct: false)], [#bubble("B", correct: false)], [#bubble("C", correct: true)], [#bubble("D", correct: false)],
  [10], [#bubble("A", correct: false)], [#bubble("B", correct: false)], [#bubble("C", correct: true)], [#bubble("D", correct: false)],
  ...
  [13], [#bubble("A", correct: false)], [#bubble("B", correct: true)], [#bubble("C", correct: false)], [#bubble("D", correct: false)],
  [14], [#bubble("A", correct: false)], [#bubble("B", correct: false)], [#bubble("C", correct: false)], [#bubble("D", correct: true)],
  [15], [#bubble("A", correct: false)], [#bubble("B", correct: false)], [#bubble("C", correct: true)], [#bubble("D", correct: false)],
)
